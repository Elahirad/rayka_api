...
from rayka_api.db.dependencies import get_db_session
from rayka_api.db.utils import create_database, drop_database
from rayka_api.services.rabbit.dependencies import get_rmq_channel_pool
from rayka_api.services.rabbit.lifespan import init_rabbit, shutdown_rabbit
from rayka_api.services.redis.dependency import get_redis_pool
from rayka_api.settings import settings
from rayka_api.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from rayka_api.db.models import load_all_models
